...
fileManagers() {
    paru -S nemo thunar dolphin --noconfirm
}
...
# NOTE: Install FDM manually from site.
browser() {
    paru -S firefox min thunderbird --noconfirm
}
...
stores() {
    ...
    helper
    # Install flatpak
    paru -S flatpak libpamac-flatpak-plugin --noconfirm
