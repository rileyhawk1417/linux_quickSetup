...
terminals() {
    paru -S kitty alacritty miniterm st --noconfirm
}
...
editors() {
    ...
    paru -S neovim vim visual-studio-code-bin vscodium-bin --noconfirm
}
...
getCli() {
    paru -S thefuck httpie cmus ncmpcpp neofetch exa ncdu nnn ripgrep ranger lf --noconfirm
}
